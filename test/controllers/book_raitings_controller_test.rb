...
class BookRaitingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should update book_raiting' do
    patch book_raiting_url(@book_raiting),
          params: { book_raiting: { book_id: @book_raiting.book_id, client_id: @book_raiting.client_id, rating_value: @book_raiting.rating_value } }
