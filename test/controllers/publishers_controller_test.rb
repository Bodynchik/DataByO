...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create publisher' do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { publisher_name: @publisher.publisher_name } }
    end
  ...
  test 'should update publisher' do
    patch publisher_url(@publisher), params: { publisher: { publisher_name: @publisher.publisher_name } }
