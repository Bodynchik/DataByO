...
class BookReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_review" do
    assert_difference("BookReview.count") do
      post book_reviews_url, params: { book_review: { book_id: @book_review.book_id, library_card_id: @book_review.library_card_id, review_text: @book_review.review_text } }
    end
  ...
  test "should update book_review" do
    patch book_review_url(@book_review), params: { book_review: { book_id: @book_review.book_id, library_card_id: @book_review.library_card_id, review_text: @book_review.review_text } }
