...
class BorrowedBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create borrowed_book" do
    assert_difference("BorrowedBook.count") do
      post borrowed_books_url, params: { borrowed_book: { book_id: @borrowed_book.book_id, date_borrowed: @borrowed_book.date_borrowed, date_due: @borrowed_book.date_due, library_card_id: @borrowed_book.library_card_id, status: @borrowed_book.status } }
    end
  ...
  test "should update borrowed_book" do
    patch borrowed_book_url(@borrowed_book), params: { borrowed_book: { book_id: @borrowed_book.book_id, date_borrowed: @borrowed_book.date_borrowed, date_due: @borrowed_book.date_due, library_card_id: @borrowed_book.library_card_id, status: @borrowed_book.status } }
